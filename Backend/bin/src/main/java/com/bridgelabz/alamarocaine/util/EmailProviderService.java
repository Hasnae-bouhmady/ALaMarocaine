package com.bridgelabz.alamarocaine.util;
...
public class EmailProviderService {
	...
	private void send(Session session, String fromEmail, String emailContact, String emailSubject, String body) {
		...
		try {
			...
			mimeMessage.setFrom(new InternetAddress(fromEmail, "A LA MAROCAINE"));
			...
			e.printStackTrace();
			System.out.println("Une exception s'est produite lors de l'envoi du mail");
